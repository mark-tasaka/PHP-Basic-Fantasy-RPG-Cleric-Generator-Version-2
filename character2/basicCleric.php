...
<html>
<head>
<title>Basic Fantasy RPG Cleric Character Generator</title>
 
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.2.1/jquery.min.js"></script>
    
	<meta charset="UTF-8">
	<meta name="description" content="Basic Fantasy RPG Cleric Character Generator. Chris Gonnerman.">
...
<body>
    ...
    $generationMessage = generationMesssage ($abilityScoreGen);
        ...
        if(isset($_POST["theArmourV2"]))
        {
            $armour = $_POST["theArmourV2"];
        }
        ...
        if(isset($_POST["theShieldV2"]))
        {
            $shield = $_POST["theShieldV2"];
        }
  ...
  <img id="character_sheet"/>
   ...
   <span id="strength">
       ...
       <span id="totalArmourWeight">
            <?php
                echo "Armour/shield weight: " . $totalArmourWeight . " lb";
            ?>
       </span>
