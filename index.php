...
<html>
<head>
<title>Launch Page: Cleric Character Generator Basic Fantasy RPG</title>
...
<body>
	...
	<section>
		...
		<h1><img src="launchPage/images/title.png" alt="Cleric Character Generator Basic Fantasy RPG" class="image" /></h1>
    ...
    <option value="1" selected>1st Level, Cleric</option>
    <option value="2">2nd Level, Cleric</option>
    <option value="3">3rd Level, Cleric</option>
    <option value="4">4th Level, Cleric</option>
    <option value="5">5th Level, Cleric</option>
    <option value="6">6th Level, Cleric</option>
    <option value="7">7th Level, Cleric</option>
    <option value="8">8th Level, Cleric</option>
    <option value="9">9th Level, Cleric</option>
    <option value="10">10th Level, Cleric</option>
    <option value="11">11th Level, Cleric</option>
    <option value="12">12th Level, Cleric</option>
    <option value="13">13th Level, Cleric</option>
    <option value="14">14th Level, Cleric</option>
    <option value="15">15th Level, Cleric</option>
    <option value="16">16th Level, Cleric</option>
    <option value="17">17th Level, Cleric</option>
    <option value="18">18th Level, Cleric</option>
    <option value="19">19th Level, Cleric</option>
    <option value="20">20th Level, Cleric</option>
    </select>
    ...
    <select id="armour" name="theArmourV2" class="alignmentBox">			
          <option value="0" >No Armour</option>
    <option value="1">Leather Armour</option>
    <option value="2" selected>Chain Mail</option>
    <option value="3">Plate Mail</option>
    </select>
    ...
    <select id="shield" name="theShieldV2" class="alignmentBox">			
    ...
    <option value="5">5d10 gp, 5d10 pp&#42;</option>
      ...
      <input type="checkbox" name="theWeaponsV2[]" value="12"> Warhammer<br/> 
                <input type="checkbox" name="theWeaponsV2[]" value="13"> Mace<br/> 
                <input type="checkbox" name="theWeaponsV2[]" value="14"> Maul<br/> 
                <input type="checkbox" name="theWeaponsV2[]" value="15"> Club/Crugel<br/> 
                <input type="checkbox" name="theWeaponsV2[]" value="16"> Quarterstaff<br/> 
                <input type="checkbox" name="theWeaponsV2[]" value="18"> Sling<br/> 
		...
		<div class="content8">
            ...
            <br/>
                ...
                <script>
                   ...
                   $("#ClericFormV3").attr('action', "character2/basicCleric.php");
